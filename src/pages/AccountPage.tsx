...
function AccountPage() {
  ...
  return (
    <section className="mx-auto max-w-3xl space-y-6">
      <div>
        <Link to="/app/chat" className="inline-flex items-center gap-2 rounded-lg border border-slate-700 px-3 py-2 text-sm text-slate-300 transition hover:bg-slate-800">
          <ArrowLeft size={16} /> Voltar para chats
        </Link>
      </div>
